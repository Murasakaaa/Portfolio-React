...
export default function SkillCard({ icon, title, desc }: SkillCardProps) {
  return (
    <div className="flex group flex-col items-center justify-between box-border border-2 border-black px-10 py-3 h-full hover:outline-2 hover:outline-black transition-all duration-50">
      {icon}

...
export default function SeniorChat() {
  const images = [
    { src: "/projects_illu/s_chat_project/SeniorChat_Illu1.png", alt: "Illustration 1" },
    { src: "/projects_illu/s_chat_project/SeniorChat_Illu2.png", alt: "Illustration 2" },
  ];
    ...
    <>
      ...
      <main className="grow flex mx-5 gap-12 xl:mx-30 max-[61.875rem]:flex-col-reverse">
        ...
        <div className="flex-1">
          <ProjectTitleSection
            title="Projet SeniorChat"
            githubUrl="https://github.com/Draken1003/SeniorChat"
          />
